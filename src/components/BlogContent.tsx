...
export default function BlogContent({ content }: { content: string }) {
    return (
        <div className="prose sm:prose-lg dark:prose-invert max-w-none
          ...
          prose-p:text-[#161b21] dark:prose-p:text-[#cdd5de] prose-p:leading-[1.75]
          prose-a:text-[var(--color-accent)] prose-a:no-underline hover:prose-a:underline
          prose-strong:text-[#161b21] dark:prose-strong:text-[#dce3ea]
          ...
          prose-pre:bg-[#161b21] dark:prose-pre:bg-[#1b2127] prose-pre:text-[#cdd5de] prose-pre:rounded-lg prose-pre:p-5
          ...
          prose-li:text-[#161b21] dark:prose-li:text-[#cdd5de]
