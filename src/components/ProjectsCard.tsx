  ...
  return (
    <div className="projects-card">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-sm font-medium text-gray-700">My Featured Projects</h2>
      ...
      <div className="flex-grow relative">
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="w-1/2 relative rounded-lg overflow-hidden h-full bg-gray-100">
      ...
      <div className="flex justify-between items-center mt-2">
        ...
        <a 
          ...
          className="text-xs text-gray-500 hover:text-black transition-colors flex items-center"
        >
          ...
          Check out more cool projects on my GitHub
        </a>
