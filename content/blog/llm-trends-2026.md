...
date: "2026-03-08"
excerpt: "Training compute is no longer the only axis in the lab. From test-time scaling to mixture-of-experts at production scale, here's a technical tour of the trends genuinely shaping the next generation of language models."
...
But underneath the noise, there are a handful of genuinely interesting technical trends reshaping how these models are built, trained, and deployed. This post is an attempt to take stock of them honestly. No PR layer.
...
A few patterns run through all of this.
