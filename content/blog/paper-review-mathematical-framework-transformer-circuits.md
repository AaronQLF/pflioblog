...
*Standalone deep dive. If you want the broader landscape, see my [mechanistic interpretability deep dive](pflioblog/blog/mechanistic-interpretability-deep-dive) and [sparse autoencoders post](pflioblog/blog/sparse-autoencoders-llm-features). If you want to keep going on transformers, the [Attention Is All You Need](pflioblog/blog/paper-review-attention-is-all-you-need) and [Transformer-XL](pflioblog/blog/paper-review-transformer-xl) reviews are the architectural prerequisites.*
