...
*Standalone deep dive. If you want the broader landscape, see my [mechanistic interpretability deep dive](mechanistic-interpretability-deep-dive) and [sparse autoencoders post](sparse-autoencoders-llm-features). If you want to keep going on transformers, the [Attention Is All You Need](paper-review-attention-is-all-you-need) and [Transformer-XL](paper-review-transformer-xl) reviews are the architectural prerequisites.*
